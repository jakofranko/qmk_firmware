...
enum planck_layers { _QWERTY, _QWERTY_DEFAULT, _COLEMAK, _DVORAK, _LOWER, _RAISE, _PLOVER, _ADJUST };
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY_DEFAULT] = LAYOUT_planck_grid(
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Voice-|Voice+|Mus on|Musoff|MIDIon|MIDIof|      |RGBTog|RGBPrv|RGBNxt|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, AU_PREV, AU_NEXT, MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, RGB_TOG, RGB_RMOD, RGB_MOD, _______,
